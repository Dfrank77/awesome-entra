...
- [entra-workload-identity-scanner](https://github.com/Dfrank77/entra-workload-identity-scanner) - Audits app registrations and service principals for expiring credentials, orphaned apps, over-privileged grants, and stale admin consent. [![stars](https://badgen.net/github/stars/Dfrank77/entra-workload-identity-scanner)](https://badgen.net/github/stars/Dfrank77/entra-workload-identity-scanner)
