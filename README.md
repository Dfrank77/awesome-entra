...
- [entra-attack-path-visualizer](https://github.com/Dfrank77/entra-attack-path-visualizer) - Detects privilege escalation paths through role assignments, nested groups, and PIM-eligible roles using NetworkX graph analysis. [![stars](https://badgen.net/github/stars/Dfrank77/entra-attack-path-visualizer)](https://badgen.net/github/stars/Dfrank77/entra-attack-path-visualizer)
